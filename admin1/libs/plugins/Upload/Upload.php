...
class Upload
{
    ...
    function update($file, $image_name, $path, $crop_size = false)
    {
        $this->upload($file);
        if ($this->uploaded) {
            ...
            // resized to 100px wide\\\
            // $file_name = $this->random_id();
            $this->file_new_name_body = TRUE;
            $this->file_new_name_body = $image_name;
            $this->file_overwrite = TRUE;
            $this->file_new_name_ext = FALSE;
            $this->image_resize = true;
            // $this->image_convert = $format;
