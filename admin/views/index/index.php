                                        ...
                                        <div class="card-body pb-2 loadmore-content" id="BookingContent">
                                            ...
                                            <div class="rooms mt-3 d-flex align-items-center justify-content-between flex-wrap">
                                                <div class="d-flex align-items-center mb-3">
                                                    <img src="<?=PUBLIC_URL;?>images/room/room1.jpg" alt="">
                                                    <div class="ms-4 bed-text">
                                                        <h4>Queen Bed A-12324</h4>
                                                        <div class="users d-flex align-items-center">
                                                            <img src="<?=PUBLIC_URL;?>images/users/user1.jpg" alt="">
                                                            <div>
                                            ...
                                            <div class="rooms mt-3 d-flex align-items-center justify-content-between flex-wrap">
                                                <div class="d-flex align-items-center mb-3">
                                                    <img src="<?=PUBLIC_URL;?>images/room/room2.jpg" alt="">
                                                    <div class="ms-4 bed-text">
                                                        <h4>Deluxe Room B-1324</h4>
                                                        <div class="users d-flex align-items-center">
                                                            <img src="<?=PUBLIC_URL;?>images/users/user2.jpg" alt="">
                                                            <div>
                                            ...
                                            <div class="rooms mt-3 d-flex align-items-center justify-content-between flex-wrap">
                                                <div class="d-flex align-items-center mb-3">
                                                    <img src="<?=PUBLIC_URL;?>images/room/room3.jpg" alt="">
                                                    <div class="ms-4 bed-text">
                                                        <h4>King Big C-2445</h4>
                                                        <div class="users d-flex align-items-center">
                                                            <img src="<?=PUBLIC_URL;?>images/users/user3.jpg" alt="">
                                                            <div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-5 mt-4 d-flex align-items-center">
                                                            <div>
                                                                <h4><a href="javascript:void(0);" class="text-secondary">Let Travl Generate
                                                            ...
                                                            <div><a href="javascript:void(0);" class="ms-5"><i class="fas fa-arrow-right fs-20"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="front-view-slider owl-carousel owl-carousel owl-loaded owl-drag owl-dot">
                                        <div class="items">
                                            <div class="customers border">
                                                <p class="fs-16">Lorem ipsum dolor sit amet, consectetur adipiscing
                                                    elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                                                    aliqua. Ut enim ad minim veniam</p>
                                                <div class="d-flex justify-content-between align-items-center mt-4">
                                                    <div class="customer-profile d-flex ">
                                                        <img src="<?=PUBLIC_URL;?>images/users/user5.jpg" alt="">
                                                        <div class="ms-3">
                                        ...
                                        <div class="items">
                                            <div class="customers border">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mt-4">
                                                    <div class="customer-profile d-flex ">
                                                        <img src="<?=PUBLIC_URL;?>images/users/user6.jpg" alt="">
                                                        <div class="ms-3">
                                                            <h5 class="mb-0"><a href="javascript:void(0);">Kusnaidi
                                                                    Anderson</a></h5>
                                                            <span>4m ago</span>
                                        ...
                                        <div class="items">
                                            <div class="customers border">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mt-4">
                                                    <div class="customer-profile d-flex ">
                                                        <img src="<?=PUBLIC_URL;?>images/users/user7.jpg" alt="">
                                                        <div class="ms-3">
                                                            <h5 class="mb-0"><a href="javascript:void(0);">Kusnaidi
                                                                    Anderson</a></h5>
                                                            <span>4m ago</span>
