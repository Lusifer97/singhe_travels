            ...
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-2">
                                                <img alt="image" width="50" src="<?= PUBLIC_URL; ?>images/avatar/1.jpg">
                                            </div>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            <img src="<?= PUBLIC_URL; ?>images/profile/pic1.jpg" width="20" alt="" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
...
<div class="dlabnav">
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow " href="<?=URL;?>bookings" aria-expanded="false">
            ...
            <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                    ...
                    <span class="nav-text">Accomadations</span>
                </a>
            ...
            <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                    ...
                    <span class="nav-text">Inquries</span>
                </a>
        ...
        <div class="dropdown header-profile2 ">
            <div class="header-info2 text-center">
                <img src="<?= PUBLIC_URL; ?>images/profile/pic1.jpg" alt="" />
