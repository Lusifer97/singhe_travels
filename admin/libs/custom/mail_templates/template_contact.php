<?php
function template_contact($content = [])
{
    //$data['aaaa']='aaa';
													...
													<table width='100%' border='0' cellspacing='0' cellpadding='0'>
														...
														<tr>
															<td class='text pb20'
                                                                ...
                                                                <p style='color:#000; '>Your inqurey was ".$content["subject"].".</p><br>
																<p style='color:#000; '> Our team will work to resolve your issue within 24 hours. Stay tuned ...</p><br>
                                                                <p style='color:#000; '>If you have any questions, need clarifications or have concerns please do not hesitate to contact the helpdesk at the Singhe Travels: Email - <strong>info@singhetravels.com</strong>  Phone: +94 91 229 8444; WhatsApp: +94 77 688 7408(Text only).</p><br>
                                                                <p style='color:#000; '>Singhe Travels - Leading Travel Partner in Sri Lanka</p>
                                                                </td>
														</tr>
										...
										<table width='100%' border='0' cellspacing='0' cellpadding='0'>
											...
											<tr>
												<td class='text-footer1 pb10'
													...
													Powered by Singhe Travels - Software Development Team</td>
											</tr>
