...
<section class="about-us pt-6" style="background-image:url(<?= PUBLIC_URL; ?>images/background_pattern.png); background-position:bottom right;">
    <div class="container">
            ...
            <div class="row d-flex align-items-center justify-content-between">
                ...
                <div class="col-lg-6 mb-4 pe-4">
                    <div class="about-image" style="animation:none; background:transparent;">
                        <img src="<?= PUBLIC_URL; ?>images/travel.png" alt="">
                    </div>
                </div>
                <div class="col-lg-12">
...
<section class="about-us pb-0">
    <div class="section-shape section-shape1" style="background-image: url(<?= PUBLIC_URL; ?>images/shape8.png);"></div>
    <div class="container">
...
<section class="testimonial pt-9" style="background-image:url(<?= PUBLIC_URL; ?>images/testimonial.png)">
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-5 pe-4">
                <div class="testimonial-image">
                    <img src="<?= PUBLIC_URL; ?>images/travel2.png" alt="">
                </div>
            </div>
