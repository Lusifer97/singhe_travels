                ...
                <div class="listing-inner">
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-4 blog-height">
                                <div class="blog-image rounded">
                                    <a href="<?=URL;?>blog/details" style="background-image: url(<?= PUBLIC_URL; ?>images/blog/blog7.jpg);"></a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-8">
                                <div class="blog-content">
                                    <h5 class="theme mb-1">Travel</h5>
                                    <h3 class="mb-2"><a href="<?=URL;?>blog/details" class="">Harbour amid a Slowen down in singer city screening</a></h3>
                    ...
                    <div class="blog-full d-flex mb-4 border-b bg-white box-shadow p-4 rounded border-all">
                        <div class="row">
                            <div class="col-lg-5 col-md-4 blog-height">
                                <div class="blog-image rounded">
                                    <a href="#" style="background-image: url(<?= PUBLIC_URL; ?>images/blog/blog8.jpg);"></a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-8">
                                <div class="blog-content">
                    ...
                    <div class="blog-full d-flex mb-4 border-b bg-white box-shadow p-4 rounded border-all">
                        <div class="row">
                            <div class="col-lg-5 col-md-4 blog-height">
                                <div class="blog-image rounded">
                                    <a href="#" style="background-image: url(<?= PUBLIC_URL; ?>images/blog/blog2.jpg);"></a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-8">
                                <div class="blog-content">
                    ...
                    <div class="blog-full d-flex mb-4 border-b bg-white box-shadow p-4 rounded border-all">
                        <div class="row">
                            <div class="col-lg-5 col-md-4 blog-height">
                                <div class="blog-image rounded">
                                    <a href="#" style="background-image: url(<?= PUBLIC_URL; ?>images/blog/blog3.jpg);"></a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-8">
                                <div class="blog-content">
                    ...
                    <div class="blog-full d-flex mb-4 border-b bg-white box-shadow p-4 rounded border-all">
                        <div class="row">
                            <div class="col-lg-5 col-md-4 blog-height">
                                <div class="blog-image rounded">
                                    <a href="blog-single.html/index.html" style="background-image: url(<?= PUBLIC_URL; ?>images/blog/blog9.jpg);"></a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-8">
                                <div class="blog-content">
                    ...
                    <div class="blog-full d-flex mb-4 border-b bg-white box-shadow p-4 rounded border-all">
                        <div class="row">
                            <div class="col-lg-5 col-md-4 blog-height">
                                <div class="blog-image rounded">
                                    <a href="blog-single.html/index.html" style="background-image: url(<?= PUBLIC_URL; ?>images/blog/blog10.jpg);"></a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-8">
                                <div class="blog-content">
                    ...
                    <div class="blog-full d-flex mb-4 border-b bg-white box-shadow p-4 rounded border-all">
                        <div class="row">
                            <div class="col-lg-5 col-md-4 blog-height">
                                <div class="blog-image rounded">
                                    <a href="blog-single.html/index.html" style="background-image: url(<?= PUBLIC_URL; ?>images/blog/blog11.jpg);"></a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-8">
                                <div class="blog-content">
                    ...
                    <div class="blog-full d-flex mb-4 border-b bg-white box-shadow p-4 rounded border-all">
                        <div class="row">
                            <div class="col-lg-5 col-md-4 blog-height">
                                <div class="blog-image rounded">
                                    <a href="blog-single.html/index.html" style="background-image: url(<?= PUBLIC_URL; ?>images/blog/blog3.jpg);"></a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-8">
                                <div class="blog-content">
                    ...
                    <div class="blog-full d-flex mb-4 border-b bg-white box-shadow p-4 rounded border-all">
                        <div class="row">
                            <div class="col-lg-5 col-md-4 blog-height">
                                <div class="blog-image rounded">
                                    <a href="blog-single.html/index.html" style="background-image: url(<?= PUBLIC_URL; ?>images/blog/blog5.jpg);"></a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-8">
                                <div class="blog-content">
                        ...
                        <div class="author-news mb-4 box-shadow p-5 text-center rounded overflow-hidden border-all">
                            <div class="author-news-content">
                                <div class="author-thumb mb-1">
                                    <img src="<?= PUBLIC_URL; ?>images/team/img2.jpg" alt="author">
                                </div>
                                    ...
                                    <div class="tab-content" id="postsTabContent1">
                                        ...
                                        <div aria-labelledby="popular-tab" class="tab-pane fade active show" id="popular" role="tabpanel">
                                            <article class="post mb-2 border-b pb-2">
                                                <div class="s-content d-flex align-items-center justify-space-between">
                                                    <div class="sidebar-image w-25 me-3 rounded">
                                                        <a href="detail-1.html"><img src="<?= PUBLIC_URL; ?>images/trending/trending1.jpg" alt=""></a>
                                                    </div>
                                            ...
                                            <article class="post border-b pb-2 mb-2">
                                                <div class="s-content d-flex align-items-center justify-space-between">
                                                    <div class="sidebar-image w-25 me-3 rounded">
                                                        <a href="detail-1.html"><img src="<?= PUBLIC_URL; ?>images/trending/trending2.jpg" alt=""></a>
                                                    </div>
                                                    <div class="content-list w-75">
                                            ...
                                            <article class="post">
                                                <div class="s-content d-flex align-items-center justify-space-between">
                                                    <div class="sidebar-image w-25 me-3 rounded">
                                                        <a href="detail-1.html"><img src="<?= PUBLIC_URL; ?>images/trending/trending4.jpg" alt=""></a>
                                                    </div>
                                                    <div class="content-list w-75">
                                                        <h5 class="mb-1"><a href="detail-1.html">15 Unheard Ways To Achieve Greater Walker</a></h5>
                                        ...
                                        <div aria-labelledby="recent-tab" class="tab-pane fade" id="recent" role="tabpanel">
                                            <article class="post mb-2 border-b pb-2">
                                                <div class="s-content d-flex align-items-center justify-space-between">
                                                    <div class="sidebar-image w-25 me-3 rounded">
                                                        <a href="detail-1.html"><img src="<?= PUBLIC_URL; ?>images/trending/trending5.jpg" alt=""></a>
                                                    </div>
                                                    <div class="content-list w-75">
                                            ...
                                            <article class="post border-b pb-2 mb-2">
                                                <div class="s-content d-flex align-items-center justify-space-between">
                                                    <div class="sidebar-image w-25 me-3 rounded">
                                                        <a href="detail-1.html"><img src="<?= PUBLIC_URL; ?>images/trending/trending6.jpg" alt=""></a>
                                                    </div>
                                                    <div class="content-list w-75">
                                            ...
                                            <article class="post">
                                                <div class="s-content d-flex align-items-center justify-space-between">
                                                    <div class="sidebar-image w-25 me-3 rounded">
                                                        <a href="detail-1.html"><img src="<?= PUBLIC_URL; ?>images/trending/trending3.jpg" alt=""></a>
                                                    </div>
                                                    <div class="content-list w-75">
    ...
    <div class="container">
        ...
        <div class="row item-slider">
            <div class="col-lg-4">
                <div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                    <div class="trend-image">
                        <img src="<?= PUBLIC_URL; ?>images/trending/trending10.jpg" alt="image">
                    </div>
                        ...
                        <div class="trend-content">
                            ...
                            <div class="entry-meta d-flex align-items-center justify-content-between">
                                <div class="entry-author">
                                    <img src="<?= PUBLIC_URL; ?>images/reviewer/2.jpg" alt="" class="rounded-circle me-1">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                    <div class="trend-image">
                        <img src="<?= PUBLIC_URL; ?>images/trending/trending12.jpg" alt="image">
                    </div>
                    <div class="trend-content-main p-4">
                        <div class="trend-content">
                            ...
                            <div class="entry-meta d-flex align-items-center justify-content-between">
                                <div class="entry-author">
                                    <img src="<?= PUBLIC_URL; ?>images/reviewer/1.jpg" alt="" class="rounded-circle me-1">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                    <div class="trend-image">
                        <img src="<?= PUBLIC_URL; ?>images/trending/trending13.jpg" alt="image">
                    </div>
                    <div class="trend-content-main p-4">
                        <div class="trend-content">
                            <h5 class="theme mb-1">Public</h5>
                            ...
                            <div class="entry-meta d-flex align-items-center justify-content-between">
                                <div class="entry-author">
                                    <img src="<?= PUBLIC_URL; ?>images/reviewer/3.jpg" alt="" class="rounded-circle me-1">
