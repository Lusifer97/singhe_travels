<div class="traveltour-page-wrapper" id="traveltour-page-wrapper">
    <div class="tourmaster-page-wrapper tourmaster-tour-style-1 tourmaster-with-sidebar" id="tourmaster-page-wrapper">
        ...
        <div class="tourmaster-single-header" style="background-image: url(<?php echo PUBLIC_URL; ?>images/4.jpg);">
                ...
                <div class="tourmaster-single-header-container-inner">
                    ...
                    <div class="tourmaster-header-price tourmaster-item-mglr">
                        ...
                        <div class="tourmaster-header-price-wrap">
                            ...
                            <div class="tourmaster-tour-price-wrap tourmaster-discount"><span class="tourmaster-tour-price"><span class="tourmaster-head" style="color:#ffffff;">From</span><span class="tourmaster-tail"></span></span><span class="tourmaster-tour-discount-price">$<?php
                                                                                                                                                                                                                                                                if ($value["discount"] != null) {
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                ?></span><span class="fa fa-info-circle tourmaster-tour-price-info" data-rel="tipsy" title="The initial price based on 1 adult with the lowest price in low season"></span></div>
                        </div>
                    </div>
            <?php
                            }
                                        ...
                                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js ">
                                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 0px ;">
                                                        <div class="gdlr-core-title-item-title-wrap">
                                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title" style="font-size: 15px ;font-weight: 500 ;letter-spacing: 0px ;text-transform: none ;">Level<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span></h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js ">
                                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 0px ;">
                                                        <div class="gdlr-core-title-item-title-wrap">
                                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title" style="font-size: 15px ;font-weight: 500 ;letter-spacing: 0px ;text-transform: none ;">Destination List<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span></h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tourmaster-tour-grid  tourmaster-price-right-title">
                                        ...
                                        <div class="tourmaster-tour-content-wrap gdlr-core-skin-e-background">
                                            ...
                                            <div class="tourmaster-tour-rating">
                                                ...
                                                <span class="tourmaster-tour-rating-text">Duration: <?php echo $value["duration"]; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="gdlr-core-toggle-box-item-content-wrapper">
                                        ...
                                        <div class="gdlr-core-toggle-box-item-content">
                                            <div class="gdlr-core-contact-form-7-item gdlr-core-item-pdlr gdlr-core-item-pdb ">
                                                <div role="form" class="wpcf7" id="wpcf7-f1319-p1964-o1" lang="en-US" dir="ltr" style="background: #969b96;
                                                                    padding-left: 5%;
                                                                    padding-right: 5%;
                                                                    padding-bottom:2%;">
                                                    <div class="screen-reader-response"></div>
                                                    <form class="quform" onsubmit="addcomment(event,this)">
