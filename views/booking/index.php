<section class="breadcrumb-main pb-20 pt-14" style="background-image: url(<?=PUBLIC_URL;?>images/bg/bg1.jpg);">
    <div class="section-shape section-shape1 top-inherit bottom-0" style="background-image: url(<?=PUBLIC_URL;?>images/shape8.png);">
    </div>
                    ...
                    <div class="booking-box">
                        ...
                        <div class="customer-information mb-4 d-flex align-items-center bg-grey rounded p-4">
                            ...
                            <div class="customer-info ps-4">
                                ...
                                <small>You can make your payment physically connecting our agent </small>
                            </div>
                        </div>
                            ...
                            <div class="trending-topic-main">
                                ...
                                <div class="tab-content" id="postsTabContent1">
                                    ...
                                    <div aria-labelledby="card-tab" class="tab-pane fade active show" id="card" role="tabpanel">
                                        <form>
                                            <h5 class="mb-2 border-b pb-2"><i class="fa fa-credit-card"></i> Credit Card
                                            </h5>
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-4">
                                                    <img src="<?=PUBLIC_URL;?>images/cc.png" alt="" class="rounded">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="booking-terms border-t pt-3 mt-3">
                                <form class="d-lg-flex align-items-center">
                                    <div class="form-group mb-2 w-75">
                                        <input type="checkbox"> By continuing, you agree to the <a href="#">Terms and
                                            Conditions.</a>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4">
                                    <div class="trend-item2 rounded">
                                        <a href="destination-single1.html/index.html" style="background-image: url(<?=PUBLIC_URL;?>images/destination/destination17.jpg);"></a>
