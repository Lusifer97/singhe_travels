    ...
    <div class="breadcrumb-outer">
        <div class="container">
            <div class="breadcrumb-content text-center">
                <h1 class="mb-3">Destination Details</h1>
                <nav aria-label="breadcrumb" class="d-block">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Attractions</li>
                        <li class="breadcrumb-item active" aria-current="page">Attractions details</li>
                    </ul>
                </nav>
            </div>
        </div>
                ...
                <div class="single-content">
                    ...
                    <div class="description-images mb-4 overflow-hidden">
                        <div class="thumbnail-images position-relative">
                            <div class="slider-store rounded overflow-hidden">
                                <div>
                                    <img src="<?= PUBLIC_URL; ?>images/trending/trending1.jpg" alt="1">
                                </div>
                                <div>
                                    <img src="<?= PUBLIC_URL; ?>images/trending/trending2.jpg" alt="1">
                                </div>
                                <div>
                                    <img src="<?= PUBLIC_URL; ?>images/trending/trending3.jpg" alt="1">
                                </div>
                                <div>
                                    <img src="<?= PUBLIC_URL; ?>images/trending/trending5.jpg" alt="1">
                                </div>
                                <div>
                                    <img src="<?= PUBLIC_URL; ?>images/trending/trending6.jpg" alt="1">
                                </div>
                                <div>
                                    <img src="<?= PUBLIC_URL; ?>images/trending/trending7.jpg" alt="1">
                                </div>
                            </div>
                    ...
                    <div class="description mb-2">
                        ...
                        <p>Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts of Cicero's
                            De Finibus Bonorum et Malorum for use in a type specimen book.Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs.</p>
                    ...
                    <div class="single-comments single-box mb-4">
                        ...
                        <div class="comment-box">
                            <div class="comment-image">
                                <img src="<?= PUBLIC_URL; ?>images/reviewer/1.jpg" alt="image">
                            </div>
                        ...
                        <div class="comment-box">
                            <div class="comment-image">
                                <img src="<?= PUBLIC_URL; ?>images/reviewer/2.jpg" alt="image">
                            </div>
                            <div class="comment-content rounded">
                                <h5 class="mb-1">Helena</h5>
                                <p class="comment-date">April 25, 2022 at 10:46 am</p>
