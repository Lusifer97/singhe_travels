<?php
function template_confirm($content = [])
{
    //$data['aaaa']='aaa';
													...
													<table width='100%' border='0' cellspacing='0' cellpadding='0'>
														...
														<tr>
															<td class='text pb20'
                                                                ...
                                                                <p style='color:#000; '>Thank you very much for registering with us..!</p><br>
                                                                <p style='color:#000; '>Your Confimation Code is <h1>".$content["no"]."</h1></p><br>
